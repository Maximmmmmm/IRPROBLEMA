(() => {
    ...
    o = (e = 500) => {
      ...
      if (i) {
        ...
        setTimeout(() => {
          ...
          document.querySelectorAll("[data-abs]").forEach((e) => {
      ...
      if (l.length)
        return (
          l.forEach((t) => {
            ...
            i.push({ itemsArray: c, matchMedia: o });
          }),
          i
        );
    }
  ...
  const m = document.querySelectorAll("[data-absolute]");
  m.length > 0 &&
    m.forEach((e) => {
      e.style.maxWidth = document.querySelector(".wrapper").offsetWidth + "px";
      const t = e.closest("[data-absolute]");
    ...
    (function () {
      ...
      e &&
        e.addEventListener("click", function (e) {
          i && (a(), document.documentElement.classList.toggle("menu-open"));
        });
    })(),
    (function () {
        ...
        function c(e) {
          ...
          if (t.closest("[data-spoller]")) {
            ...
            i.querySelectorAll("._slide").length ||
              (a && !s.classList.contains("_spoller-active") && n(i),
